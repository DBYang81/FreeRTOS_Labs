...
clean-src:
	-$(RM) ./src/DigitalIoPin.d ./src/DigitalIoPin.o ./src/Fmutex.d ./src/Fmutex.o ./src/ITM_write.d ./src/ITM_write.o ./src/LpcUart.d ./src/LpcUart.o ./src/cr_cpp_config.d ./src/cr_cpp_config.o ./src/cr_startup_lpc15xx.d ./src/cr_startup_lpc15xx.o ./src/crp.d ./src/crp.o ./src/heap_lock_monitor.d ./src/heap_lock_monitor.o ./src/lab3_03.d ./src/lab3_03.o ./src/sysinit.d ./src/sysinit.o
