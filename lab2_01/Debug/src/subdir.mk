...
clean-src:
	-$(RM) ./src/DigitalIoPin.d ./src/DigitalIoPin.o ./src/Fmutex.d ./src/Fmutex.o ./src/LpcUart.d ./src/LpcUart.o ./src/cr_cpp_config.d ./src/cr_cpp_config.o ./src/cr_startup_lpc15xx.d ./src/cr_startup_lpc15xx.o ./src/crp.d ./src/crp.o ./src/heap_lock_monitor.d ./src/heap_lock_monitor.o ./src/lab2_01.d ./src/lab2_01.o ./src/sysinit.d ./src/sysinit.o
